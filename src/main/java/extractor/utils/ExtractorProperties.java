...
public class ExtractorProperties {
    ...
    private static final String DEFAULT_FILENAME_PROPERTIES = "extractor.application.properties";
    private static final String VM_EXTERNALISE_VAR_PATH = "extractor.externalized.properties";
